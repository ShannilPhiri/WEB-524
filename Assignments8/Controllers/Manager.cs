    ...
    public class Manager
    {
        ...
        public Manager()
        {
            ...
            var config = new MapperConfiguration(cfg =>
            {
                ...
                {
                    cfg1.CreateMap<Models.Album, Controllers.AlbumBase>();
                    cfg1.CreateMap<Models.Artist, Controllers.ArtistBase>();
                    cfg1.CreateMap<Models.Track, Controllers.TrackBase>();
                    cfg1.CreateMap<Models.Genre, Controllers.GenreBase>();
                });
                ...
                cfg.CreateMap<Models.Album, Controllers.Album>();
        ...
        {
            return Mapper.Map<IEnumerable<Models.Track>, IEnumerable<Controllers.TrackBase>>(ds.Tracks.OrderBy(t => t.Name));
        }
        // ProductGetById()
        // ProductAdd()
        // ProductEdit()
