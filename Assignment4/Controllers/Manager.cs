    ...
    public class Manager
    {
        ...
        public Manager()
        {
            ...
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<InvoiceBaseViewModel, Invoice>();
                cfg.CreateMap<Invoice, InvoiceWithDetailViewModel>();
                cfg.CreateMap<Invoice, InvoiceLineBaseViewModel>();
        ...
        {
            return mapper.Map<IEnumerable<Invoice>, IEnumerable<InvoiceBaseViewModel>>(ds.Invoices.OrderBy(ln => ln.InvoiceDate));
        }
        // ProductGetById()
        ...
        {
            var obj = ds.Invoices.Include("Customer").Include("Customer.Employee").Include("InvoiceLines.Track.Album.Artist").Include("InvoiceLines.Track.MediaType").SingleOrDefault(t => t.InvoiceId == id);
